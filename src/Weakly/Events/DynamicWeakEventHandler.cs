...
namespace Weakly
{
    ...
    /// </summary>
    public static class DynamicWeakEventHandler
    {
        /// <summary>
        /// Registers for the specified event without holding a strong reference to the <paramref name="eventSource"/>.
        /// </summary>
            ...
            where TEventArgs : EventArgs
        {
            ...
            return new DynamicWeakEventHandlerImpl<TEventArgs>(eventSource, eventInfo, handler);
        }

        #region Inner Types

        private sealed class DynamicWeakEventHandlerImpl<TEventArgs> : IDisposable
            where TEventArgs : EventArgs
        {
            ...
            public DynamicWeakEventHandlerImpl(object eventSource, EventInfo eventInfo, Action<object, TEventArgs> handler)
            {
                if (eventSource != null)
